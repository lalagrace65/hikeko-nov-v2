...
return (
    ...
    {/*basic plan subscription*/}
        <Card variant="gradient" className="w-full max-w-[20rem] p-8 bg-cardPrice shadow-xl hover:scale-[1.02] ">
            <CardHeader
                floated={false}
                shadow={false}
                color="transparent"
                ...
                >
                <Typography variant="small" className="font-normal uppercas">BASIC PLAN</Typography>
                <Typography
                    variant="h1"
        ...
        <Card variant="gradient" className="w-full max-w-[20rem] p-8 bg-cardPrice shadow-xl hover:scale-[1.02] ">
            <CardHeader
                ...
                className="m-0 mb-8 rounded-none border-b border-white/10 pb-8 text-center text-primary"
                >
                <Typography variant="small" className="font-normal uppercas">PREMIUM PLAN</Typography>
                <Typography
                    variant="h1"
                    className="mt-6 flex justify-center gap-1 text-7xl font-normal"
                >
            ...
            <CardBody className="p-0">
                <ul className="flex flex-col gap-4">
                    ...
                    <Typography className="font-normal">5 Staff Accounts</Typography>
                    </li>
                    <li className="flex items-center gap-4">
                    <span className="rounded-full border border-white/20  bg-primary p-1 text-white">
                        <CheckIcon />
                    </span>
                    <Typography className="font-normal">Up to 10 Events per month</Typography>
                    </li>
                    <li className="flex items-center gap-4">
                    <span className="rounded-full border border-white/20 bg-primary p-1 text-white">
                        <CheckIcon />
                    </span>
                    <Typography className="font-normal">2 Ads per month</Typography>
                    </li>
                </ul>
            </CardBody>
            <CardFooter className="mt-12 p-0">
